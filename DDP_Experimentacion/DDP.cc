...
vector<int> *X_coor, vector<int> *Y_coor, vector<float> *Demand, vector<int> *ReadyTime, vector<int> *DueTime){
    ...
    while(true){
        ...
        if(instancia)
            ...
            cout << "Archivo no existente. Ingrese nuevamente." << endl; 
    }
...
vector<vector<int>> Swap(vector<vector<int>> Rutas, int DroneNum, vector<int> *NodosSwap){
    ...
    cout << "Swap => DroneElegido: " << DroneElegido << " / PrimerNodo: " << NuevaRuta[PrimerNodo] << " / SegundoNodo: " << NuevaRuta[SegundoNodo] << endl;
...
vector<vector<int>> MoverCliente(vector<vector<int>> Rutas, int DroneNum, vector<int> *NodosMover){
    ...
    cout << "MoverCliente => DroneElegido: " << DroneElegido << " / NodoSeleccionado: " << NuevaRuta[PrimerNodo] << " / Posicion: " << SegundoNodo << endl;
...
vector<vector<int>> MoverCliente2(vector<vector<int>> Rutas, int DroneNum, vector<int> *NodosMover){
    ...
    cout << "MoverCliente2 => Drone1: " << Drone1 << " / Drone2: " << Drone2 << " / NodoSeleccionado: " << ClienteMovido << " / Posicion: " << SegundoNodo << endl;
    Rutas[Drone1] = Ruta1;
    Rutas[Drone2] = Ruta2;
...
vector<vector<int>> CrearRuta(vector<vector<int>> Rutas, int DroneNum, vector<int> *NodosCortar){
    ...
    cout << "CrearRuta => Drone: " << DroneElegido << " / NodoSeleccionado: " << NuevaRuta[NodoSeleccionado] << " / Posicion: " << Posicion << endl;
...
vector<vector<int>> CrearRuta2(vector<vector<int>> Rutas, int *NumRutas, int NumDrones, vector<int> *NodosCortar){
    ...
    if(Drone2 >= NumRutasAux){
        ...
        *NumRutas = NumRutasAux;
        ...
        cout << "CrearRuta2 => Drone1: " << Drone1 << " / Drone2: " << Drone2 << " / NodoSeleccionado: " << Ruta1[NodoSeleccionado] << " / Posicion: " << Posicion << endl;
        NodosCortar->push_back(Posicion);
        NodosCortar->push_back(FlagCortar);
        NodosCortar->push_back(UnicoCliente);
...
vector<vector<int>> BalanceoCargaA1(vector<vector<int>> Rutas, int DroneNum, vector<int> *NodosSwap, vector<int> *RutaMovida){
    ...
    if(DroneOcupado != DroneDesocupado){
        ...
        if(FlagInfactible != 1){
            ...
            cout << "BalanceoCargaA1 => Drone1: " << DroneOcupado << " / Drone2: " << DroneDesocupado << " / InicioRuta: " << InicioRuta << " / FinRuta: " << FinRuta << " / Posicion: " << Posicion << " / Flag: " << FlagBalanceo << endl;
        }
...
vector<vector<int>> BalanceoCargaA2(vector<vector<int>> Rutas, int DroneNum, vector<int> *NodosBalanceo){
    ...
    if(Drone1 != Drone2){
        ...
        cout << "BalanceoCargaA2 => Drone1: " << Drone1 << " / Drone2: " << Drone2 << " / NodoSeleccionado: " << ClienteMovido << " / Posicion: " << SegundoNodo << endl;
        Rutas[Drone1] = Ruta1;
        Rutas[Drone2] = Ruta2;
...
vector<vector<int>> BalanceoCargaB(vector<vector<int>> Rutas, int NumRutas, int NumDrones, vector<int> *NodosBalanceo){
    ...
    if(Drone1 != Drone2){
        ...
        cout << "BalanceoCargaB => " << "Drone1: " << Drone1 << " / Drone2: " << Drone2 << " / NodoSeleccionado: " << Ruta1[NodoSeleccionado] << " / Posicion: " << Posicion << " / UnicoCliente: " << UnicoCliente << endl;
...
vector<int> DueTime, vector<float> Demand, float Capacidad, float CapacidadEnergetica, int delta, int tipo){
    ...
    for(i=NodoMenor;i<Largo;i++){
        cout << "Nodo actual: " << Rutas[Drone][i] << endl;
        ...
        if(Rutas[Drone][i] == DepositoOrigen){
            ...
            if(DistanciaActual > DueTime[Rutas[Drone][i]]){
                cout << "Distancia excedida por nodo: " << Rutas[Drone][i] << " con distancia: " << DistanciaActual << endl;
                return false;
            }
            ...
            if(EnergiaActual <= CapacidadEnergetica){
                ...
                if(PesoAcumulado <= Capacidad){
                    ...
                    cout << "Capacidad excedida por nodo: " << Rutas[Drone][i] << " con capacidad: " << PesoAcumulado << endl;
                    return false;
                }
            }
            else{
                cout << "Energia excedida por nodo: " << Rutas[Drone][i] << " con energia: " << EnergiaActual << endl;
                return false;
            }
        }
    }
...
vector<int> DueTime, vector<float> Demand, float Capacidad, float CapacidadEnergetica, int delta, int tipo){
    ...
    for(i=NodoSeleccionado;i<Largo;i++){
        cout << "Nodo actual: " << Rutas[Drone1][i] << endl;
        ...
        if(Rutas[Drone1][i] == DepositoOrigen){
            ...
            if(DistanciaActual > DueTime[Rutas[Drone1][i]]){
                cout << "Distancia excedida por nodo: " << Rutas[Drone1][i] << " con distancia: " << DistanciaActual << endl;
                return false;
            }
            ...
            if(EnergiaActual <= CapacidadEnergetica){
                ...
                if(PesoAcumulado <= Capacidad){
                    ...
                    cout << "Capacidad excedida por nodo: " << Rutas[Drone1][i] << " con capacidad: " << PesoAcumulado << endl;
                    return false;
                }
                   
            }
            else{
                cout << "Energia excedida por nodo: " << Rutas[Drone1][i] << " con energia: " << EnergiaActual << endl;
                return false;
            }
    ...
    for(i=PosicionDestino;i<Largo;i++){
        cout << "Nodo actual: " << Rutas[Drone2][i] << endl;
        ...
        if(Rutas[Drone2][i] == DepositoOrigen){
            ...
            if(DistanciaActual > DueTime[Rutas[Drone2][i]]){
                cout << "Distancia excedida por nodo: " << Rutas[Drone2][i] << " con distancia: " << DistanciaActual << endl;
                return false;
            }
            ...
            if(EnergiaActual <= CapacidadEnergetica){
                ...
                if(PesoAcumulado <= Capacidad){
                    ...
                    cout << "Capacidad excedida por nodo: " << Rutas[Drone2][i] << " con capacidad: " << PesoAcumulado << endl;
                    return false;
                }
                   
            }
            else{
                cout << "Energia excedida por nodo: " << Rutas[Drone2][i] << " con energia: " << EnergiaActual << endl;
                return false;
            }
...
vector<float> Demand, float Capacidad, float CapacidadEnergetica, float *FuncionEvaluacion, int NumRutas, int NumDrones, int delta, int tipo, float q, int CantidadMovimientos, vector<float> *Temperaturas, vector<float> *Calidades, vector<int> *Evaluaciones, vector<int> *FlagPerturbacion){
    ...
    vector<vector<int>> RutasAnteriores, RutasOperador;
    ...
    vector<int> NodosSwap, RutaMovida, NumeradoresExploracion, Estadisticas_Perturbacion = *EstadisticasPerturbacion, Evaluaciones_Pert = *Evaluaciones, Flag_Perturbacion = *FlagPerturbacion;
    ...
    while(ContadorAceptacion < CantidadMovimientos){
        ...
        if(Movimiento == 0){
            ...
            if(Factible){
                cout << "Movimiento aplicado: BalanceoCargaA1" << endl;
                ContadorAceptacion++;
        ...
        // Movimiento: BalanceoCargaA2
            ...
            if(Factible){
                cout << "Movimiento aplicado: BalanceoCargaA2" << endl;
                ContadorAceptacion++;
        ...
        // Movimiento: BalanceoCargaB
            ...
            if(Factible){
                cout << "Movimiento aplicado: BalanceoCargaB" << endl;
                ContadorAceptacion++;
...
vector<vector<float>> *Pesos, int CustNum, int DroneNum, float Capacidad, float CapacidadEnergetica, int *NumRutas){
    ...
    float Q1, Q2, Q3, LimiteDemanda, TiempoActual = 0, EnergiaActual = 0, Energia, PesoCarga = 1.5, EnergiaDeposito;
    ...
    if(CustNum % 2 == 0){
        Q1 = (float)CustNum / 4;
        Q2 = (float)(2 * CustNum) / 4;
        Q3 = (float)(3 * CustNum) / 4;
    }
    // Impar
    else{
        Q1 = (float)(CustNum + 1) / 4;
        Q2 = (float)(2 * (CustNum + 1)) / 4;
    ...
    while(true){
            ...
            *NumRutas = DronesUsados;
            ...
            if(VerificarDrone(DroneID, CustNum, DroneActual)){
                ...
                if(NodoActual == NodeID[0]){
                    ...
                    EnergiaAcumulada += ConsumoEnergetico(X_coor[NodoActual], Y_coor[NodoActual], X_coor[0], Y_coor[0], PesoCarga);
                    if(EnergiaAcumulada > CapacidadEnergetica)
                        cout << "Se sobrepasa la capacidad energética al intentar ir al depósito" << endl;
                    Ruta.push_back(NodeID[CustNum+1]);
                    Tiempos_Nodos.push_back(TiempoAcumulado);
                    Tiempos_Espera.push_back(0);
                    Energia_Nodos.push_back(EnergiaAcumulada);
                ...
                if(DroneActual < DroneNum)
                    ...
                    cout << "No se encuentran más drones disponibles" << endl;
                    break;
                }
            ...
            if(TodosVisitados(ClientesPesados, LargoNodosPesados) && Fase == 1){
                ...
                Fase++;
                for(j=0;j<(int)Ruta.size();j++)
                    cout << Ruta[j] << " ";
                cout << endl;
                for(j=0;j<(int)Tiempos_Nodos.size();j++)
                    cout << Tiempos_Nodos[j] << " ";
                cout << endl;
                for(j=0;j<(int)Energia_Nodos.size();j++)
                    cout << Energia_Nodos[j] << " ";
                cout << endl;
            }
            ...
            if(Fase == 1){
                for(j=0; j<LargoNodosPesados; j++){
                    ...
                    cout << "NodoAnterior: " << NodoAnterior << ", NodoActual: " << j << ", Distancia: " << Distancia << endl;
        ...
        if(Fase == 3){
            ...
            cout << "Nodo seleccionado: " << NodoActual << " MasTemprano: " << MasTemprano << endl;
        }
        ...
        if(HaciaDeposito)
            cout << NodoAnterior << "->" << NodoActual << ", Distancia: " << Distancia << ", Energia: " << EnergiaDeposito << endl;
        else
            cout << NodoAnterior << "->" << NodoActual << ", Distancia: " << Distancia << ", Energia: " << EnergiaAcumulada << endl;
        TiempoAcumulado += Distancia;
        ...
        if(TiempoAcumulado > DueTime[NodoActual]){
            ...
            cout << "Excedo el límite superior de la ventana de tiempo" << endl;
            TiempoAcumulado -= Distancia;
            CapacidadAcumulada -= Demand[NodoActual];
...
int Iteraciones_SA, int Iteraciones_CambioT, float Temperatura_Inicial, float Factor_Enfriamiento){
    ...
    vector<int> NodosSwap, RutaMovida, NumeradoresExploracion, NumeradoresExplotacion, Estadisticas_SA = *EstadisticasSA, Evaluaciones_SA = *Evaluaciones, Flag_Perturbacion = *FlagPerturbacion;
    ...
    while(ContadorIteraciones < Iteraciones_SA){
        while(ContadorCambioTemp < Iteraciones_CambioT){
            ...
            if(Movimiento == 0){
                ...
                if(NewFuncionEvaluacion < *FuncionEvaluacion && Factible){
                    cout << "Movimiento aplicado: Swap" << endl;
                    Estadisticas_SA[0]++;
                    *FuncionEvaluacion = NewFuncionEvaluacion;
                    Rutas = RutasOperador;
                    ProbAcumuladasExplotacion = ActualizarProbabilidades(&NumeradoresExplotacion, &DenominadorExplotacion, Movimiento);
            ...
            // Movimiento: MoverCliente
                ...
                // Mejora la calidad de la solución y es factible
                if(NewFuncionEvaluacion < *FuncionEvaluacion && Factible){
                    cout << "Movimiento aplicado: MoverCliente" << endl;
                    Estadisticas_SA[2]++;
                    *FuncionEvaluacion = NewFuncionEvaluacion;
                    Rutas = RutasOperador;
                    ProbAcumuladasExplotacion = ActualizarProbabilidades(&NumeradoresExplotacion, &DenominadorExplotacion, Movimiento);
            ...
            // Movimiento: MoverCliente2
                ...
                // Mejora la calidad de la solución y es factible
                if(NewFuncionEvaluacion <= *FuncionEvaluacion && Factible){
                    cout << "Movimiento aplicado: MoverCliente2" << endl;
                    Estadisticas_SA[4]++;
                    *FuncionEvaluacion = NewFuncionEvaluacion;
                    Rutas = RutasOperador;
                    ProbAcumuladasExplotacion = ActualizarProbabilidades(&NumeradoresExplotacion, &DenominadorExplotacion, Movimiento);
            ...
            // Movimiento: CrearRuta
                ...
                // Mejora la calidad de la solución y es factible
                if(NewFuncionEvaluacion < *FuncionEvaluacion && Factible){
                    cout << "Movimiento aplicado: CrearRuta" << endl;
                    Estadisticas_SA[6]++;
                    *FuncionEvaluacion = NewFuncionEvaluacion;
                    Rutas = RutasOperador;
                    ProbAcumuladasExplotacion = ActualizarProbabilidades(&NumeradoresExplotacion, &DenominadorExplotacion, Movimiento);
            ...
            // Movimiento: CrearRuta2
                ...
                // Mejora la calidad de la solución y es factible
                if(NewFuncionEvaluacion <= *FuncionEvaluacion && Factible){
                    cout << "Movimiento aplicado: CrearRuta2" << endl;
                    Estadisticas_SA[8]++;
                    *FuncionEvaluacion = NewFuncionEvaluacion;
                    Rutas = RutasOperador;
                    ProbAcumuladasExplotacion = ActualizarProbabilidades(&NumeradoresExplotacion, &DenominadorExplotacion, Movimiento);
...
int main(int argc, char **argv){
    ...
    int CustNum, DroneNum, i, j, NumRutas, IteracionesTotales = 0;
    float FuncionEvaluacion;
    string NombreInstancia;
    vector<int> NodeID, X_coor, Y_coor, ReadyTime, DueTime, NodosSwap, EstadisticasPerturbacion(6, 0), EstadisticasSA(10, 0), Iteraciones, VisitadosDrones, Evaluaciones, FlagPerturbacion;
    ...
    // Seed = 5, Iteraciones_ILS = 30, Iteraciones_SA = 30000, Iteraciones_CambioT = 163, Movimientos_Perturbacion = 10;
    // Temperatura_Inicial = 121, Factor_Enfriamiento = 1;
    // Instancia = "Set_A1_Cust_45_1";
    ...
    Salida << "------------------------------------------------------------------------------------------------------------\n\n";
    Salida << "Solución Greedy:\n\n";
    Salida << "Función evaluación: ";
    Salida << trunc(FuncionEvaluacion*100)/100.0f;
    Salida << "\n\n";

    for(i=0;i<(int)Rutas.size();i++){
        Salida << "Rutas Drone " + to_string(i+1) + ": ";
        for(j=0;j<(int)Rutas[i].size();j++){
            Salida << to_string(Rutas[i][j]) + " ";
        }
        Salida << "\n";
    }
    Salida << "\n";

    for(i=0;i<(int)Tiempos.size();i++){
        Salida << "Tiempos Drone " + to_string(i+1) + ": ";
        for(j=0;j<(int)Tiempos[i].size();j++){
            Salida << trunc(Tiempos[i][j]*100)/100.0f;
            Salida << " ";
        }
        Salida << "\n";
    }
    ...
    for(i=0;i<(int)Energias.size();i++){
        Salida << "Energias Drone " + to_string(i+1) + ": ";
        for(j=0;j<(int)Energias[i].size();j++){
            Salida << trunc(Energias[i][j]*100)/100.0f;
            Salida << " ";
        }
        Salida << "\n";
    }
    ...
    for(i=0;i<(int)Pesos.size();i++){
        Salida << "Pesos Drone " + to_string(i+1) + ": ";
        for(j=0;j<(int)Pesos[i].size();j++){
            Salida << trunc(Pesos[i][j]*100)/100.0f;
            Salida << " ";
        }
        Salida << "\n";
    }
    ...
    for(i=0;i<(int)Rutas_ILS.size();i++){
        Salida << "Rutas Drone " + to_string(i+1) + ": ";
        for(j=0;j<(int)Rutas_ILS[i].size();j++){
            Salida << to_string(Rutas_ILS[i][j]) + " ";
        }
        Salida << "\n";
    }
    Salida << "\n";
    ...
    Salida << "------------------------------------------------------------------------------------------------------------\n\n";
    Salida << "Estadísticas:\n\n";
    Salida << "Iteraciones totales: " + to_string(IteracionesTotales) + "\n\n";

    Salida << "Apariciones BalanceoCargaA1: " + to_string(EstadisticasPerturbacion[0]) + "/" + to_string(EstadisticasPerturbacion[1]) + "\n";
    Salida << "Apariciones BalanceoCargaA2: " + to_string(EstadisticasPerturbacion[2]) + "/" + to_string(EstadisticasPerturbacion[3]) + "\n";
    Salida << "Apariciones BalanceoCargaB: " + to_string(EstadisticasPerturbacion[4]) + "/" + to_string(EstadisticasPerturbacion[5]) + "\n";
    Salida << "Apariciones Swap: " + to_string(EstadisticasSA[0]) + "/" + to_string(EstadisticasSA[1]) + "\n";
    Salida << "Apariciones MoverCliente: " + to_string(EstadisticasSA[2]) + "/" + to_string(EstadisticasSA[3]) + "\n";
